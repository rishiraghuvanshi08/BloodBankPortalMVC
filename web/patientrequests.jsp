<%-- 
    Document   : patientrequests
    Created on : Aug 14, 2022, 10:18:25 PM
...
<html>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg bg-primary navbar-dark sticky-top py-lg-0 px-lg-5 wow fadeIn"
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav me-auto p-3 p-lg-0">
                    ...
                    <a href="receivers.jsp" class="nav-item nav-link">Receivers</a>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown">Requests</a><!-- Pages -->
                        <div class="dropdown-menu border-0 rounded-0 rounded-bottom m-0">
                            <a href="donorsrequests.jsp" class="dropdown-item">Donors</a><!-- Features -->
                            <a href="patientrequests.jsp" class="dropdown-item active">Patients</a><!-- Our Team -->
        ...
        <%
            String b = (String)request.getAttribute("reqsuccess");
            if(b != null)
            {
                %>
                    <div class="alert alert-success alert-dismissible show wow fadeIn mb-0" data-wow-delay="0.1s" role="alert">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Request Successful!</strong> <a href="receivers.jsp">Click here</a> to check the list.
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                <%
            }
        ...
        <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
            <div class="container text-center py-5">
                <h1 class="display-4 text-white animated slideInDown mb-3">Requests</h1>
                <nav aria-label="breadcrumb animated slideInDown">
                    <ol class="breadcrumb justify-content-center mb-0">
                        <li class="breadcrumb-item"><a class="text-white" href="#">Home</a></li>
                        <li class="breadcrumb-item"><a class="text-white" href="#">Pages</a></li>
                        <li class="breadcrumb-item text-primary active" aria-current="page">Patients</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="container-xxl pt-2">
            <div class="container">
                <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    <h6 class="section-title bg-white text-center text-primary px-3 mb-4">Requests from Patients</h6>
                ...
                <table class="table table-striped table-class" id="table-id">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" class="col-lg-1">Units Req.</th>
                            <th scope="col" class="col-lg-2">Units Provided</th>
                    ...
                    <tbody>
                        <%
                            try {
                                ...
                                String query = "Select aadhar,name,age,gender,blood_group,address,contact,units_req from patient_request";
                        ...
                        <tr>
                                    ...
                                    <form action="RequestCompelteChecker" method="post">
                            ...
                            <td><%=rs.getString(8) %></td>
                                        <input type="hidden" name="units_req" value="<%=rs.getString(8) %>" >
                            <td><input style="width: 115px;" type="number" name="units_given" class="text-center" max="100" min="1" oninvalid="this.setCustomValidity('Please enter units less than or equal to required.')" oninput="this.setCustomValidity('')" required></td>
                            <td>
                                <div class="private-container">
                                        <button class="my-button"><i class="fa fa-check text-primary"></i></button>
                                    </form>
                                    <form action="DeletePatientReqChecker" method="post">
                                        <input type="hidden" name="aadhar" value="<%=rs.getString(1)%>" >
