<%-- 
    Document   : process
    Created on : Oct 5, 2022, 10:44:08 AM
        ...
        <nav class="navbar navbar-expand-lg bg-primary navbar-dark sticky-top py-lg-0 px-lg-5 wow fadeIn"
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav me-auto p-3 p-lg-0">
                    ...
                    <a href="process.jsp" class="nav-item nav-link active">Team</a>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    <h6 class="section-title bg-white text-center text-primary px-3">Team of Managers</h6>
                    <!--<h1 class="display-6 mb-4">We Are A Creative Team For Your Dream Project</h1>-->
                </div>
                <div class="row g-4">
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="team-item text-center p-4">
                            <img class="img-fluid border rounded-circle w-75 p-2 mb-4" src="img/doctor-1.jpg" alt="">
                            <div class="team-text">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="team-item text-center p-4">
                            <img class="img-fluid border rounded-circle w-75 p-2 mb-4" src="img/doctor-2.jpg" alt="">
                            <div class="team-text">
                                <div class="team-title">
                                    <h5>Rishi</h5>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="team-item text-center p-4">
                            <img class="img-fluid border rounded-circle w-75 p-2 mb-4" src="img/doctor-3.jpg" alt="">
                            <div class="team-text">
                                <div class="team-title">
                                    <h5>Vishal</h5>
