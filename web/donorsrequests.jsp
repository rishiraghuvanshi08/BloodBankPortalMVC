<%-- 
    ...
    Created on : Aug 14, 2022, 10:05:47 PM
...
<html>
    ...
    <body>
            ...
            <div class="row align-items-center top-bar">
                <div class="col-lg-4 col-md-12 text-center text-lg-start">
                    <a href="" class="navbar-brand m-0 p-0">
                        <h1 class="fw-bold text-primary m-0"><img src="img/drop2.png" alt="" width="35px"></i> Blood Bank</h1>
                ...
                <div class="navbar-nav me-auto p-3 p-lg-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu border-0 rounded-0 rounded-bottom m-0">
                            <a href="donorsrequests.jsp" class="dropdown-item active">Donors</a><!-- Features -->
        ...
        <div class="alert alert-danger alert-dismissible show wow fadeIn mb-0" data-wow-delay="0.1s" role="alert">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Donation Failed! </strong> Enter correct units.
        ...
        <div class="alert alert-success alert-dismissible show wow fadeIn mb-0" data-wow-delay="0.1s" role="alert">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Donation Successful!</strong> <a href="donors.jsp">Click here</a> to check the list.
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>
        <%
            }
                    ...
                    <tbody>
                        <%
                            try {
                                ...
                                String query = "Select * from donor_request";
