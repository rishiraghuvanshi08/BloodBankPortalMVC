<%-- 
    Document   : registered
    Created on : Aug 15, 2022, 9:51:01 AM
...
<html>
    ...
    <body>
        <%
            ...
            if (aadhar == null || aadhar.trim().equals("")) {
        ...
        <div class="container-xxl py-5 px-5">
            <div class="container text-center">
                <div class="card">
                    <h4 class="card-header">Registration Successful</h4>
                    <div class="card-body">
                        <h5 class="card-title">Thank you for Registration</h5>
                        <p class="card-text">We have successfully registered your request. Your Aadhar Number is <%=aadhar %>. We will update you as soon as possible.</p>
                        <a href="templogout.jsp" class="btn btn-primary">Back to Home</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!--        <nav class="navbar navbar-expand-lg bg-primary navbar-dark sticky-top py-lg-0 px-lg-5 wow fadeIn"
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <div class="navbar-nav me-auto p-3 p-lg-0">
                            <a href="webhome.html" class="nav-item nav-link">Home</a>
                            <a href="donate.html" class="nav-item nav-link">Donate</a> About Us 
                            <a href="request.html" class="nav-item nav-link">Request</a> Services 
                        ...
                        <a href="login.html" class="btn btn-sm btn-light rounded-pill py-2 px-4 d-none d-lg-block">Log In</a>
                    </div>
                </nav>-->
        <!-- Navbar End -->
                                ...
                                <form action="" method="">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12 text-center">
                                            <input type="submit" class="btn btn-primary rounded-pill py-3 px-5" value="Log In">
                                        </div>
                                    </div>
                                </form>
                            </div>
                    ...
                    <div class="container py-5">
                        <div class="row g-5">
                            ...
                            <div class="col-lg-3 col-md-6">
                                ...
                                <a class="btn btn-link" href="donors.html">Donors</a>
                                <a class="btn btn-link" href="">Receivers</a>
